...
CREATE TABLE `p1_parcela` (
    ...
    `p1_id_emprestimo` INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE `p1_parcela` ADD CONSTRAINT `p1_parcela_p1_id_emprestimo_fkey` FOREIGN KEY (`p1_id_emprestimo`) REFERENCES `e1_emprestimo`(`e1_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
